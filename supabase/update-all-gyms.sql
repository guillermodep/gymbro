-- Update/Insert all gyms with complete information
-- This ensures all 16 gyms have full data like McKenzies Fitness Studio

-- First, delete existing gyms to avoid conflicts
TRUNCATE TABLE public.gyms RESTART IDENTITY CASCADE;
